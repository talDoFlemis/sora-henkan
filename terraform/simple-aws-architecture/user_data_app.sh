...
services:
  ...
  worker:
    ...
    environment:
      ...
      WORKER_DYNAMODB_AWS_ENDPOINT: https://dynamodb.${AWS_REGION}.amazonaws.com
      WORKER_DYNAMODB_AWS_ANONYMOUS: false
      WORKER_DYNAMODB_TABLE: ${DYNAMODB_TABLE}
      GOMEMLIMIT: 700MiB
      GOGC: 50
    depends_on:
      migrate:
  ...
  api:
    ...
    environment:
      ...
      API_DYNAMODB_AWS_ENDPOINT: https://dynamodb.${AWS_REGION}.amazonaws.com
      API_DYNAMODB_AWS_ANONYMOUS: false
      API_DYNAMODB_TABLE: ${DYNAMODB_TABLE}
      GOMEMLIMIT: 200MiB
      GOGC: 50
    depends_on:
      migrate:
