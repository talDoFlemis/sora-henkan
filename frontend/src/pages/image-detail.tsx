                  ...
                  <div className="space-y-4">
                    ...
                    {transformations.length === 0 && (
                      <div className="text-center py-8 text-gray-500">
                        ...
                        <p className="text-sm">
                          Add at least one transformation above
                        </p>
                      </div>
                    )}
                    ...
                    {transformations.map((transform, index) => (
                      <Card
                        key={index}
                        className="p-4 bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200"
                      >
                ...
                <div className="flex justify-between py-2 border-b">
                  ...
                  <dd>
                    <Badge
                      className={
                        statusColors[
                          image.status as keyof typeof statusColors
                        ] || "bg-gray-500"
                      }
                    >
                      {image.status}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        window.open(image.original_image_url, "_blank")
                      }
                    >
              ...
              {image.transformations.length === 0 ? (
                ...
                <ul className="space-y-3">
                  {image.transformations.map((t, i) => (
                    <li
                      key={i}
                      className="bg-gradient-to-r from-indigo-50 to-purple-50 p-3 rounded-lg border border-indigo-100"
                    >
